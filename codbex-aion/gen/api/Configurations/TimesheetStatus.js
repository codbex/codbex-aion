...
const dao = require("aion/gen/dao/Configurations/TimesheetStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/aion/gen/api/TimesheetStatus.js/" + entity.Id);

...
const dao = require("codbex-aion/gen/dao/Configurations/TimesheetStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-aion/gen/api/TimesheetStatus.js/" + entity.Id);

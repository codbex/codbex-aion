...
const dao = require("codbex-aion/gen/dao/Configurations/ProjectStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-aion/gen/api/ProjectStatus.js/" + entity.Id);

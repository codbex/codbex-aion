...
const dao = require("codbex-aion/gen/dao/Configurations/TaskStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-aion/gen/api/TaskStatus.js/" + entity.Id);

...
const dao = require("aion-app/gen/dao/Configurations/TimesheetStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/aion-app/gen/api/TimesheetStatus.js/" + entity.Id);

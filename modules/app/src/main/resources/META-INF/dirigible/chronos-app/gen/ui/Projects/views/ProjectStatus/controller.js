...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'chronos-app.Projects.ProjectStatus.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('chronos-app.Projects.ProjectStatus.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/chronos-app/gen/api/Projects/ProjectStatus.js';

...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'chronos-app.Timesheets.TimesheetStatus.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('chronos-app.Timesheets.TimesheetStatus.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/chronos-app/gen/api/Timesheets/TimesheetStatus.js';

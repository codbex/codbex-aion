...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'chronos-app.Employees.Employee.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('chronos-app.Employees.Employee.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v4/js/chronos-app/gen/api/Employees/Employee.js';

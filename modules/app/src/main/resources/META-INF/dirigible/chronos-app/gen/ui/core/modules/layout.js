...
angular.module('ideLayout', ['idePerspective', 'ideMessageHub', 'ideView'])
    ...
    .directive('ideLayout', ['Views', 'SplitPaneState', 'messageHub', 'perspective', function (Views, SplitPaneState, messageHub, perspective) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/layout.html'
        };
    }])
    ...
    .directive('explorerToolbar', ['perspective', function (perspective) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/toolbar.html',
        };
    }])
    ...
    .directive('accordionPane', ['$timeout', 'perspective', function ($timeout, perspective) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/accordionPane.html'
        };
    }])
    .directive('tabs', function () {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/tabs.html'
        };
    })
    ...
    .directive('splittedTabs', function () {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/splittedTabs.html'
        };
    });
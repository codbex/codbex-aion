...
const dao = require("chronos-app/gen/dao/Configurations/TaskStatus");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("TaskStatus not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/chronos-app/gen/api/TaskStatus.js/" + entity.Id);

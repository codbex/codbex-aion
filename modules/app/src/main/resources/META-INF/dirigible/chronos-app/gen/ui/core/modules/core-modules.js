...
angular.module('idePerspective', ['ngResource', 'ngCookies', 'ideTheming', 'ideMessageHub'])
    ...
    .service('Perspectives', ['$resource', function ($resource) {
        return $resource('/services/v4/js/chronos-app/gen/ui/core/services/perspectives.js');
    }])
    .service('Menu', ['$resource', function ($resource) {
        return $resource('/services/v4/js/chronos-app/gen/ui/core/services/menu.js');
    }])
    .service('User', ['$http', function ($http) {
        return {
            get: function () {
                let user = {};
                $http({
                    url: '/services/v4/js/chronos-app/gen/ui/core/services/user-name.js',
                    method: 'GET'
                }).then(function (data) {
                    user.name = data.data;
                });
    ...
    .service('DialogWindows', ['$resource', function ($resource) {
        return $resource('/services/v4/js/chronos-app/gen/ui/core/services/dialog-windows.js');
    }])
    ...
    .directive('ideContextmenu', ['messageHub', '$window', function (messageHub, $window) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/contextmenu.html'
        };
    }])
    .directive('ideContextmenuSubmenu', ['$window', function ($window) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/contextmenuSubmenu.html'
        };
    }])
    .directive('ideHeader', ['$window', '$cookies', '$resource', 'branding', 'theming', 'User', 'Menu', 'messageHub', function ($window, $cookies, $resource, branding, theming, User, Menu, messageHub) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/ideHeader.html'
        };
    }])
    .directive("headerHamburgerMenu", ['messageHub', function (messageHub) {
        return {
            ...
            templateUrl: "/services/v4/web/chronos-app/gen/ui/core/modules/templates/headerHamburgerMenu.html",
        };
    }])
    .directive("headerMenu", ['messageHub', function (messageHub) {
        return {
            ...
            templateUrl: "/services/v4/web/chronos-app/gen/ui/core/modules/templates/headerMenu.html",
        };
    }])
    .directive("headerSubmenu", function () {
        return {
            ...
            templateUrl: "/services/v4/web/chronos-app/gen/ui/core/modules/templates/headerSubmenu.html",
        };
    })
    ...
    .directive('ideSidebar', ['Perspectives', 'perspective', 'messageHub', function (Perspectives, perspective, messageHub) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/ideSidebar.html'
        }
    }])
    /**
    ...
    .directive('ideDialogs', ['messageHub', 'DialogWindows', 'perspective', function (messageHub, DialogWindows, perspective) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/ideDialogs.html'
        }
    }])
    .directive('ideStatusBar', ['messageHub', function (messageHub) {
        return {
            ...
            templateUrl: '/services/v4/web/chronos-app/gen/ui/core/modules/templates/ideStatusBar.html'
        }
    }]);
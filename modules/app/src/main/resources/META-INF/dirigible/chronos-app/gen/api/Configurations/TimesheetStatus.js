...
const dao = require("chronos-app/gen/dao/Configurations/TimesheetStatus");
...
rs.service()
	...
	.resource("{id}")
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound("TimesheetStatus not found");
			}
		})
		.produces(["application/json"])
		.catch(function(ctx, error) {
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/v4/js/chronos-app/gen/api/TimesheetStatus.js/" + entity.Id);

        ...
        this.$get = ['$q', '$http', function ($q, $http) {
            ...
            return {
                ...
                getDeveloperProjects: function () {
                    return httpGet('/services/v4/js/aion-ext/services/developer/myprojects.js');
                },
                getDeveloperProjectTasks: function (projectId) {
                    return httpGet(`/services/v4/js/aion-ext/services/developer/mytasks.js?ProjectId=${projectId}`);
                },
                getDeveloperTimesheets: function (projectId, statusIds = []) {
                    const statusParams = statusIds.map(x => `&StatusId=${x}`).join('');
                    return httpGet(`/services/v4/js/aion-ext/services/developer/mytimesheets.js?ProjectId=${projectId}${statusParams}`);
                },

...
app.controller('controller', ['$scope', '$q', 'utilities', 'classNames', 'api', 'theming', function ($scope, $q, utilities, classNames, api, theming) {
    ...
    const loadTasks = function (projectId) {
        return new $q((resolve, reject) => {
            ...
            if (tasks) {
                ...
                api.getEmployeeProjectTasks(projectId)
                    .then(projectTasks => {
    ...
    $scope.loadTimesheets = function () {
        ...
        if (projectId) {
            api.getEmployeeTimesheets(projectId, [TimesheetStatus.Opened, TimesheetStatus.Reopened, TimesheetStatus.Rejected])
